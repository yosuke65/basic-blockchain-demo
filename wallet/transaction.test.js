...
describe("Transaction", () => {
  ...
  it("outputs the `amount` subtraction from the wallet balance", () => {
    expect(
  ...
  it("outputs the `amount` addition to the recipient", () => {
    expect(
  ...
  describe("updating the transaction", () => {
    ...
    it("outputs the next amount to the next recipient", () => {
      expect(
